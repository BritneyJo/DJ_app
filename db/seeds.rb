...
User.destroy_all
u1 = User.create(name: 'Pretty Lights', location: 'Fort Collins, Colorado', bio: 'Derek Vincent Smith, also known as Pretty Lights, is 31 years old, and his sign is a Sagittarius.', email: 'prettylights@dj.com', password: 'music', avatar_image: 'http://live360booking.com/wp-content/uploads/2012/02/pretty-lights-music-49313-199x300.jpg')
u2 = User.create(name: 'Bassnectar', location: 'Santa Cruz, California', bio: 'Bassnectar is 35 years old, and his zodiac is Aquarius.', email: 'bassnectar@dj.com', password: 'music', avatar_image: 'http://gypsysphere.files.wordpress.com/2011/02/bassnectar05.jpg?w=480&h=320')
